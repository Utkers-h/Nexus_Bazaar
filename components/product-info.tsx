...
export function ProductInfo({product}:Props) {
  ...
  // to update the cart we just need to call the useshopping cart function
  const {addItem,cartDetails,incrementItem} = useShoppingCart()
  // to check whether the same item is in the cart so that to increase its count
  ...
  function addToCart() {
    ...
    // to display notification and other useful data on screen
    toast({
  ...
  return (
    <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
      ...
      <div className="mt-4">
        ...
        {/* to display the sizes for different products */}
